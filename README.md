About mscxyz-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mscxyz-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13266&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mscxyz-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mscxyz` can be installed with `conda`:
...
```
mamba install mscxyz
```

It is possible to list all of the versions of `mscxyz` available on your platform with `conda`:
...
```
mamba search mscxyz --channel conda-forge
```
...
mamba repoquery search mscxyz --channel conda-forge

# List packages depending on `mscxyz`:
mamba repoquery whoneeds mscxyz --channel conda-forge

# List dependencies of `mscxyz`:
mamba repoquery depends mscxyz --channel conda-forge
```
